...
We also need a random distribution of corporate donations. Because it is lognormally distributed, we can take the natural log of the boundary conditions and find a normal distribution across those. The ln of 50000 and 1000000 is `r exp(50000)` and `r exp (1000000)` respectively. We can simulate corporate donations by selecting from a normal distribution that uses these values as the bounds for the 90% confidence interval.
